...
namespace Portal.Ibanez.Migrations
{
    ...
    [Migration("20260723192834_AddMachineDownloadLinks")]
    partial class AddMachineDownloadLinks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portal.Ibanez.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Portal.Ibanez.MachineDownloadLinks.MachineDownloadLink", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppMachineDownloadLinks", (string)null);
                });

            modelBuilder.Entity("Portal.Ibanez.Machines.Machine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Portal.Ibanez.Machines.MachineType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppMachineTypes", (string)null);
                });

            modelBuilder.Entity("Portal.Ibanez.QrCodes.QrCode", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Portal.Ibanez.DocumentFolders.DocumentFolder", b =>
                {
                    b.HasOne("Portal.Ibanez.DocumentFolders.DocumentFolder", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Portal.Ibanez.MachineDownloadLinks.MachineDownloadLink", b =>
                {
                    b.HasOne("Portal.Ibanez.Machines.Machine", null)
                        .WithOne()
                        .HasForeignKey("Portal.Ibanez.MachineDownloadLinks.MachineDownloadLink", "MachineId")
